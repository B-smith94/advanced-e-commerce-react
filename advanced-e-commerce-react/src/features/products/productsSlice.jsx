...
export const fetchProducts = createAsyncThunk( // Thunk -- function to perform delayed computation (not just Redux)
    'products/fetchProducts', // tells redux where to locate the outcome
